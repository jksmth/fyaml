...
// marshal_map.go contains canonical mode marshaling implementations (works with interface{} maps)
...
// marshalLeafMap marshals a leaf node in canonical mode (returns interface{} map).
func (n *Node) marshalLeafMap(opts *Options) (interface{}, error) {
...
// marshalParentMap marshals a parent node in canonical mode (returns interface{} map).
func (n *Node) marshalParentMap(opts *Options) (interface{}, error) {
